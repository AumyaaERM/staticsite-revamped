        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-8 md:mb-12">
          ...
          {/* Contact */}
            ...
            <h4 className="font-bold text-lg mb-3 md:mb-4 text-black" style={{ fontFamily: 'Days One, sans-serif' }}>Contact Us</h4>
              ...
              <li><a style={{ color: '#000000', textDecoration: 'none' }} href="mailto:contact@aumyaa.com" className="hover:underline break-all">contact@aumyaa.com</a></li>
              <li><a style={{ color: '#000000', textDecoration: 'none' }} href="https://www.yuktiarora.in/" className="hover:underline" target="_blank" rel="noopener noreferrer">Blogs ↗</a></li>
              <li><a style={{ color: '#000000', textDecoration: 'none' }} href="https://www.instagram.com/aumyaa_training" className="hover:underline" target="_blank" rel="noopener noreferrer">Instagram ↗</a></li>
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <a
              ...
              className="text-sm text-black hover:underline inline-flex items-start gap-2 group"
            ...
            <p className="text-sm text-black mt-3 ml-7" style={{ fontFamily: 'Inter, sans-serif' }}>
              10am—6pm
            </p>
          </div>
          </div>
          ...
          <div className="flex gap-3 md:gap-4">
            ...
            <a href="https://www.youtube.com/@aumyaalearningacademy5425" target="_blank" rel="noopener noreferrer" className="w-9 h-9 md:w-10 md:h-10 rounded-full border-2 border-black flex items-center justify-center hover:bg-black transition-colors group" style={{ textDecoration: 'none', color: '#FF0000' }}>
              <svg className="w-4 h-4 md:w-5 md:h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ fill: 'currentColor' }}>
                <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/aumyaa_training" target="_blank" rel="noopener noreferrer" className="w-9 h-9 md:w-10 md:h-10 rounded-full border-2 border-black flex items-center justify-center hover:bg-black transition-colors group" style={{ textDecoration: 'none', color: '#E4405F' }}>
              <svg className="w-4 h-4 md:w-5 md:h-5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" style={{ fill: 'currentColor' }}>
