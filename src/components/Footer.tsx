    ...
    <footer className="bg-yellow-400 py-8 md:py-12 px-4 sm:px-6 md:px-12">
        ...
        <div className="border-t border-gray-600 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-3 md:gap-4">
            ...
            <a href="https://www.youtube.com/@aumyaalearningacademy5425" target="_blank" rel="noopener noreferrer" className="w-9 h-9 md:w-10 md:h-10 rounded-full border-2 border-black flex items-center justify-center hover:bg-black hover:text-yellow-400 transition-colors group">
