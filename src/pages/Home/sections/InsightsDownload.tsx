...
export const InsightsDownloads: React.FC = () => {
    return (
      <div className="grid grid-cols-3 gap-8 px-12 py-16 bg-gray-50">
        <div className="col-span-2 bg-yellow-400 p-12 rounded-2xl">
          <h2 className="text-5xl font-bold text-center mb-8 pb-4 border-b-2 border-black">Insights</h2>
        ...
        <div className="bg-yellow-400 p-8 rounded-2xl">
          <h2 className="text-5xl font-bold text-center mb-8 pb-4 border-b-2 border-black">Downloads</h2>
          
          <div className="space-y-4">
            <button className="w-full bg-black text-white font-semibold py-4 px-6 rounded flex items-center gap-3 hover:bg-gray-800 transition-colors">
