...
const ChatButton: React.FC = () => {
  return (
    ...
    <Link to="/contact" className="float-right bottom-8 right-8 bg-white text-[#FFD700] font-bold px-8 py-4 rounded-full flex items-center gap-3 shadow-[0_8px_0_0_#FFD700] hover:shadow-[0_10px_0_0_#FFD700] hover:translate-y-[-2px] transition-all z-50">
      Chat With Us
